      ...
      <div className="grid grid-cols-2 gap-3">
        {types.map((type, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[#c9a962]/5 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          </button>
        ))}
      </div>
    </div>
