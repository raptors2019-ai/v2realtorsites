...
import { getAssignments } from '@/lib/projects'
...
export default async function AssignmentsPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-secondary">
      ...
      {/* Info Cards */}
      <section className="py-8 bg-white dark:bg-secondary">
        <div className="container mx-auto px-4">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          {assignments.length > 0 ? (
            <ProjectGrid projects={assignments} />
          ) : (
            <div className="max-w-3xl mx-auto">
              <div className="text-center py-12 bg-cream dark:bg-secondary-light rounded-xl">
                ...
                <h3 className="text-xl font-semibold text-secondary dark:text-white mb-2">
                  No Assignment Listings Available
                </h3>
                <p className="text-text-secondary dark:text-gray-300 mb-6 max-w-md mx-auto">
                  Check back soon for assignment opportunities, or connect with us
                  to be notified when new listings become available.
                </p>
                <Link
      ...
      {/* How It Works */}
      <section className="py-12 bg-cream dark:bg-secondary-light">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
